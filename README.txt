...
В связи с чем приложением работает только старых версиях формата JMX, там где использовались node.
Сейчас же используются hashTree и некоторые описания элементов вынысены из тегов в атрибуты.
