...
Что нового в этой версии?!
    1. Добавлена индикация изменения элементов структуры хранения параметров, полученной из xml-дерева. Данный функционал добавлен
    в целях удобства работы с элементами. См. п. 10.2.
    2. Существенно повышена надежность приложения при работе (отображении и редактировании) с элементами (раб. коллекц.). Теперь выкидывание
    из приложения при нарушениях логики работы с приложением, либо случайных действиях пользователя не должно. Хотя возможно - что-то было 
